...
import OverviewAeroflotDays from '../sections/overview/overview-aeroflotDays';
import { useEffect, useState } from 'react';
import CookieConsentDialog from '../sections/customer/CookieConsentDialog';
...
const Page = () => {
  ...
  console.log("Page MAIN start URL:",document.URL);
  return(
  <>
    <Head>
      <title>
